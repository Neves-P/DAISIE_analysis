comparison_stt_results <- function(generating_simuluations = "sim-DAISIE-1-7-1000-7.48223e-05-1-0.05-0.001-1-1000-0.1-15-13500-0.1-1-9.RData",
  ...
  parsed_final <- DAISIE::DAISIE_convert_to_classic_plot(resulting_simulations[[1]]$out)


  parsed_final_list <- list()
  for (i in seq_along(parsed_final)) {
    parsed_final_list[i] <- DAISIE::DAISIE_convert_to_classic_plot(resulting_simulations[[1]]$out)
  }
