...
#   pilot_study_parameters$Amax[1],
#   pilot_study_parameters$Apeak[1],
#   pilot_study_parameters$Asharpness[1],
#   pilot_study_parameters$Atotalage[1]
# )
#
# Epars <- c(
#   pilot_study_parameters$mu_min[1],
#   pilot_study_parameters$mu_max[1]
# )
# DAISIE_sim(
#   time = time,
#   M = M,
